...
**How it works:** Data is collected automatically via GitHub Actions from all nine platforms. Editorial blurbs are generated by Claude. The blog runs on Jekyll + GitHub Pages. Every item ever featured lives in the [catalog](/repos/) for browsing, searching, and filtering.

**Stay updated:** Subscribe via [RSS feed](/VaiBReport/feed.xml) to get each daily digest in your reader of choice.
